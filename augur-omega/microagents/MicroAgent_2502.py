# MicroAgent 2502 - Proficiency Support Agent - Carnival Domain
import logging
import asyncio
import json
...
class MicroAgent2502Controller(Controller):
    path = "/microagent-2502"
    ...
    def _initialize_microagent(self) -> None:
        ...
        self.agent = MicroAgent(
            id="MA-2502",
            name="Proficiency Support Agent - Carnival Domain",
    ...
    async def process(self, request_data: MicroAgentRequest) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Processing error in MicroAgent-2502: {e}")
            return {"error": str(e)}
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Health check error in MicroAgent-2502: {e}")
